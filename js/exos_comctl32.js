...
(function(global){
  if(
    ...
    String(global.jplopsoft_EXOS_COMCTL32.version||'')==='6.4.0-dev-os47'
  ){
    return;
  }
...
function jplopsoft_comctlListIconNode(
  ...
  if(jplopsoft_EXFS_SVG_ICONS[iconName]){
