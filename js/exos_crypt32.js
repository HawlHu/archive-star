/* ExOS crypt32.xdl + bcrypt.xdl emulation
...
var C={version:'6.4.0-dev-os86',model:'EXOS_CRYPT32_V1',ready:true};
var B={version:'6.4.0-dev-os86',model:'EXOS_BCRYPT_V1',ready:true};
...
async function cryptDispatch(ctx,method,args){args=args||[];method=String(method||'');need();
 ...
 if(method==='ExMd3'||method==='CryptHashData'){var alg=method==='ExMd3'?'EX_MD3':String(args[1]||'EX_MD3').toUpperCase();if(alg!=='EX_MD3')throw exerr(st('NOT_SUPPORTED',0xC00000BB),'CryptHashData supports EX_MD3; use bcrypt.xdl for SHA-2.');return global.ex_md3(md3Input(args[0]));}
 ...
 throw exerr(st('NOT_SUPPORTED',0xC00000BB),'Unsupported crypt32.xdl API: '+method);
}
async function bcryptDispatch(ctx,method,args){args=args||[];method=String(method||'');
 ...
 throw exerr(st('NOT_SUPPORTED',0xC00000BB),'Unsupported bcrypt.xdl API: '+method);
}
