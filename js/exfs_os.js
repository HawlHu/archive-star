...
var jplopsoft_EXPLORER_DEBUG={
  ...
  observer:null,
  autoShowTimer:0,
  storageKey:'EXOS_EXPLORER_DEBUG_LOG_V1'
};
...
window.jplopsoft_EXOS_OS={
  ready:true,
  version:'6.4.0-dev-os25',
  build:'external-os-explorer-diagnostic-log'
};
